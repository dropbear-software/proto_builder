...
const ListShelvesResponse$json = const {
  ...
  '2': const [
    const {'1': 'shelves', '3': 1, '4': 3, '5': 11, '6': '.example.bookstore.Shelf', '10': 'shelves'},
  ],
};

/// Descriptor for `ListShelvesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listShelvesResponseDescriptor = $convert.base64Decode('ChNMaXN0U2hlbHZlc1Jlc3BvbnNlEjIKB3NoZWx2ZXMYASADKAsyGC5leGFtcGxlLmJvb2tzdG9yZS5TaGVsZlIHc2hlbHZlcw==');
@$core.Deprecated('Use createShelfRequestDescriptor instead')
const CreateShelfRequest$json = const {
  '1': 'CreateShelfRequest',
  '2': const [
    const {'1': 'shelf', '3': 1, '4': 1, '5': 11, '6': '.example.bookstore.Shelf', '10': 'shelf'},
  ],
};

/// Descriptor for `CreateShelfRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createShelfRequestDescriptor = $convert.base64Decode('ChJDcmVhdGVTaGVsZlJlcXVlc3QSLgoFc2hlbGYYASABKAsyGC5leGFtcGxlLmJvb2tzdG9yZS5TaGVsZlIFc2hlbGY=');
...
const ListBooksResponse$json = const {
  '1': 'ListBooksResponse',
  '2': const [
    const {'1': 'books', '3': 1, '4': 3, '5': 11, '6': '.example.bookstore.Book', '10': 'books'},
  ],
};

/// Descriptor for `ListBooksResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listBooksResponseDescriptor = $convert.base64Decode('ChFMaXN0Qm9va3NSZXNwb25zZRItCgVib29rcxgBIAMoCzIXLmV4YW1wbGUuYm9va3N0b3JlLkJvb2tSBWJvb2tz');
@$core.Deprecated('Use createBookRequestDescriptor instead')
const CreateBookRequest$json = const {
  '1': 'CreateBookRequest',
  '2': const [
    const {'1': 'shelf', '3': 1, '4': 1, '5': 3, '10': 'shelf'},
    const {'1': 'book', '3': 2, '4': 1, '5': 11, '6': '.example.bookstore.Book', '10': 'book'},
  ],
};

/// Descriptor for `CreateBookRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createBookRequestDescriptor = $convert.base64Decode('ChFDcmVhdGVCb29rUmVxdWVzdBIUCgVzaGVsZhgBIAEoA1IFc2hlbGYSKwoEYm9vaxgCIAEoCzIXLmV4YW1wbGUuYm9va3N0b3JlLkJvb2tSBGJvb2s=');
